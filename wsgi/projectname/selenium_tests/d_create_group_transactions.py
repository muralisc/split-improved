...
select_element = Select(driver.find_element_by_xpath("//select[@name='toCategoryGroup']"))
select_element.select_by_visible_text('Bills')
...
select_element = Select(driver.find_element_by_xpath("//select[@name='toCategoryGroup']"))
select_element.select_by_visible_text('Food')
